            ...
            <ul class="navbar-nav">
              ...
              if (isset($_SESSION['id'])) {
                if ($_SESSION['id'] == 1) {
                  ...
                  echo "<li class='nav-item'> <a href='mdelete.php' class='nav-link'>Delete Movie</a> </li>";
                }
              }
              ...
              echo"<h1 style='color:white;position:sticky;'>WELCOME </h1><b style = 'color: white;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                ...
                <div class='row'>
                  <div class='col'>
                    ...
                    <input type='submit' name='submit' class='btn btn-success' style='display:inline;width:200px;margin-left:20px;margin-right:20px;' value='".ucwords($rel2['mname'])."'/></h4>
                    </form>
                  </div>
                  <div class='col'>
